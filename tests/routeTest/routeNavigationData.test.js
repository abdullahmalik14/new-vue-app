/**
 * routeNavigationResourceLoader.js — Phase D (route test plan §23).
 */
...
describe('routeNavigationData (Phase D §23)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('resolveCurrentSectionForNavigation returns string sections directly', () => {
    const section = resolveCurrentSectionForNavigation({ meta: { section: 'auth' } }, 'guest');
  ...
  it('loadCurrentSectionResources skips translation fetch when already loaded', () => {
