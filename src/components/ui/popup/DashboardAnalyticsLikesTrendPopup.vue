      ...
      <div class="flex flex-col gap-3 p-4 rounded w-full h-[25rem] relative">
        <div class="flex justify-between items-center z-10 relative">
          ...
          <div class="flex gap-1 bg-[#F9FAFB] p-1 rounded-lg border border-[#EAECF0]">
            <button class="p-1.5 rounded-md cursor-pointer transition-all focus:outline-none hover:!bg-transparent" :class="activeLikesViewMode==='bar'?'bg-white shadow-sm':'bg-transparent'" @click="setLikesView('bar')">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" :stroke="activeLikesViewMode==='bar'?'#344054':'#98A2B3'" stroke-width="2" stroke-linecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
            </button>
            <button class="p-1.5 rounded-md cursor-pointer transition-all focus:outline-none hover:!bg-transparent" :class="activeLikesViewMode==='line'?'bg-white shadow-sm':'bg-transparent'" @click="setLikesView('line')">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" :stroke="activeLikesViewMode==='line'?'#344054':'#98A2B3'" stroke-width="2" stroke-linecap="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
            </button>
          </div>
        </div>
        ...
        <div v-if="hasLikesData" class="absolute top-[40px] left-0 right-0 bottom-[30px]">
          ...
          <div data-chart-container data-chart-id="likes-chart-line" :hidden="activeLikesViewMode!=='line'||undefined" class="absolute inset-0"
