...
import BasePlanDropdown from '../../global/plan/HelperComponents/BasePlanDropdown.vue';
...
const handleAmountInput = (e) => {
    // For InputComponentDashboard, the emitted value is directly the string when using v-model.
