...
<template>
  <div class="p-6 space-y-6 max-w-7xl mx-auto">
    <div class="flex items-center justify-between sticky top-0 bg-white z-50 py-4 border-b">
      <h1 class="text-3xl font-bold">DropdownMenu — Comprehensive Test Suite</h1>
      <RouterLink to="/"
    ...
    <section class="border-2 border-blue-500 rounded-lg p-6 bg-blue-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <p class="text-sm text-gray-600 mb-2">Expected: Console error "[DropdownMenu] Anchor element not found or not
          mounted."</p>
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <p class="text-sm text-gray-600 mb-3">
          ...
          that DropdownMenu creates when rendering the dropdown. This is the element that gets teleported to the body 
    ...
    <section class="border-2 border-purple-500 rounded-lg p-6 bg-purple-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div v-if="showInvalidTriggerTest">
          ...
          <DropdownMenu :anchor="invalidTriggerAnchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div v-if="showInvalidAlignTest">
          ...
          <DropdownMenu :anchor="invalidAlignAnchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div v-if="showInvalidSnapEdgeTest">
          ...
          <DropdownMenu :anchor="invalidSnapEdgeAnchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-2">
          ...
          <div v-if="showInvalidWidthTest">
            ...
            <DropdownMenu :anchor="invalidWidthAnchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-2">
          ...
          <div v-if="showInvalidHeightTest">
            ...
            <DropdownMenu :anchor="invalidHeightAnchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <DropdownMenu :anchor="test26" :config="{ style: { class: 'bg-white border rounded shadow-xl' } }">
    ...
    <section class="border-2 border-green-500 rounded-lg p-6 bg-green-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <DropdownMenu ref="test34ref" :anchor="test34"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <DropdownMenu :anchor="test36parent"
          ...
          <div class="p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="py-2 border-b">
                ...
                <DropdownMenu :anchor="test36child"
          ...
          overlay z-[999] < dropdown z-[1000]</p>
            ...
            <div class="space-y-2">
              ...
              <div>
                ...
                <DropdownMenu ref="test61bref" :anchor="test61b"
    ...
    <section class="border-2 border-yellow-500 rounded-lg p-6 bg-yellow-50">
      ...
      <div class="mb-6 bg-yellow-100 p-4 rounded-lg border-l-4 border-yellow-600">
        ...
        <p class="text-sm text-gray-700 mb-3">
          This section tests the <strong>programmatic interface</strong> of DropdownMenu. There are two main ways to interact with dropdowns programmatically:
        </p>
        <div class="grid md:grid-cols-2 gap-4 mb-3">
          <div class="bg-white p-3 rounded">
            <h4 class="font-semibold mb-2 text-blue-700">1. Events (Reactive)</h4>
            <p class="text-xs text-gray-700 mb-2">
              DropdownMenu emits events when things happen (open, close, reposition, etc.). You listen to these events to react to dropdown state changes.
            </p>
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="mb-3 p-3 bg-blue-50 rounded border-l-4 border-blue-500">
          ...
          <p class="text-sm text-gray-700 mb-2">
            DropdownMenu emits Vue events that you can listen to using <code class="bg-white px-1 rounded">@open</code>, 
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        <h3 class="font-semibold mb-2">✓ Test 7.2: DOM CustomEvents (DropdownMenu:open, close, repositioned)</h3>
        <div class="mb-3 p-3 bg-blue-50 rounded border-l-4 border-blue-500">
          <p class="text-sm font-semibold mb-2">What this tests:</p>
          <p class="text-sm text-gray-700 mb-2">
            In addition to Vue events, DropdownMenu also dispatches native DOM <code class="bg-white px-1 rounded">CustomEvent</code> objects 
            on the <code class="bg-white px-1 rounded">document</code>. These events are named <code class="bg-white px-1 rounded">DropdownMenu:open</code>, 
            <code class="bg-white px-1 rounded">DropdownMenu:close</code>, etc.
          </p>
          <p class="text-sm font-semibold mb-2">Why this matters:</p>
          <ul class="text-sm text-gray-700 ml-4 list-disc space-y-1">
        ...
        <DropdownMenu :anchor="test72"
          ...
          <div class="p-4">
            ...
            <ul class="list-disc ml-4 mt-2 text-sm space-y-1">
              <li><strong>Click to open</strong> → <code class="bg-gray-100 px-1 rounded">DropdownMenu:open</code> event fires</li>
              <li><strong>Click outside to close</strong> → <code class="bg-gray-100 px-1 rounded">DropdownMenu:close</code> event fires</li>
              <li><strong>On reposition</strong> → <code class="bg-gray-100 px-1 rounded">DropdownMenu:repositioned</code> event fires</li>
            </ul>
            <p class="text-xs text-gray-500 mt-3">
              These events are available globally via <code class="bg-gray-100 px-1 rounded">document.addEventListener('DropdownMenu:open', ...)</code>
            </p>
          </div>
        </DropdownMenu>
      </div>
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <DropdownMenu ref="test73ref" :anchor="test73anchor"
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="mb-3 p-3 bg-orange-50 rounded border-l-4 border-orange-500">
          <p class="text-sm font-semibold mb-2">What this tests:</p>
          <p class="text-sm text-gray-700 mb-2">
            DropdownMenu maintains a <strong>stack</strong> of open dropdowns. By default, when a new dropdown opens, 
    ...
    <section class="border-2 border-teal-500 rounded-lg p-6 bg-teal-50">
      ...
      <div class="mb-6 bg-teal-100 p-4 rounded-lg border-l-4 border-teal-600">
        ...
        <p class="text-sm text-gray-700 mb-3">
          This section tests how DropdownMenu manages its <strong>lifecycle</strong> - from creation to destruction. 
        ...
        <p class="text-xs text-gray-600 italic">
          ...
          on wrong elements, and dropdowns appearing in unexpected places. This section verifies DropdownMenu handles 
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="mb-3 p-3 bg-red-50 rounded border-l-4 border-red-500">
          <p class="text-sm font-semibold mb-2">What this tests:</p>
          <p class="text-sm text-gray-700 mb-2">
            DropdownMenu dynamically adds and removes event listeners based on the dropdown's open/closed state. 
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="mb-3 p-3 bg-blue-50 rounded border-l-4 border-blue-500">
          ...
          <p class="text-sm text-gray-700 mb-2">
            ...
            and <code class="bg-white px-1 rounded">popstate</code> (for history-based routing). DropdownMenu can automatically 
    ...
    <section class="border-2 border-gray-500 rounded-lg p-6 bg-gray-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-2">
          ...
          <div>
            ...
            <DropdownMenu :anchor="test102c" :config="{ trigger: 'click', theme: 'dropdown-panel', width: 320 }">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <DropdownMenu ref="test103ref" :anchor="test103"
    ...
    <section class="border-2 border-cyan-500 rounded-lg p-6 bg-cyan-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <DropdownMenu :anchor="testT4a" :config="{
              trigger: 'hover',
              layer: 'tooltip',
              offset: 12,
              width: 220,
          ...
          <div style="margin-top: 200px;">
            ...
            <DropdownMenu :anchor="testT4b" :config="{
              trigger: 'hover',
              layer: 'tooltip',
              offset: 12,
              width: 220,
          ...
          <div class="flex justify-start">
            ...
            <DropdownMenu :anchor="testT4c" :config="{
              trigger: 'hover',
              layer: 'tooltip',
          ...
          <div class="flex justify-end">
            ...
            <DropdownMenu :anchor="testT4d" :config="{
              trigger: 'hover',
              layer: 'tooltip',
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="mb-3 p-3 bg-indigo-50 rounded border-l-4 border-indigo-500">
          <p class="text-sm font-semibold mb-2">What this tests:</p>
          <p class="text-sm text-gray-700 mb-2">
            DropdownMenu uses a <strong>layer system</strong> to separate different types of floating elements. 
        ...
        <DropdownMenu :anchor="testT7dropdown"
        ...
        <DropdownMenu :anchor="testT7tooltip"
          :config="{ trigger: 'hover', layer: 'tooltip', theme: 'tooltip-dark', width: 200, ariaRole: 'tooltip', scrollEnabled: false }">
          <div class="relative">
            <div class="absolute left-1/2 -translate-x-1/2 -top-2 w-2 h-2 rotate-45 bg-gray-900"></div>
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-4">
          <div>
            ...
            <DropdownMenu :anchor="testT8parent"
              ...
              <div class="p-4">
                ...
                <DropdownMenu :anchor="testT8child"
          ...
          <div>
            ...
            <DropdownMenu :anchor="testT8parentHover"
              ...
              <div class="p-4">
                ...
                <DropdownMenu :anchor="testT8childHover"
    ...
    <section class="border-2 border-amber-500 rounded-lg p-6 bg-amber-50">
      ...
      <div class="test-case mb-6 p-4 bg-white rounded border">
        ...
        <div class="space-y-4">
          ...
          <p class="text-xs text-gray-500">Note: This uses Vue's transition, not DropdownMenu's fixed positioning.
...
if (typeof document !== 'undefined') {
  document.addEventListener('DropdownMenu:open', (e) => console.log('🔵 DOM Event - OPEN:', e.detail))
  document.addEventListener('DropdownMenu:close', (e) => console.log('🔴 DOM Event - CLOSE:', e.detail))
  document.addEventListener('DropdownMenu:repositioned', (e) => console.log('🟡 DOM Event - REPOSITIONED:', e.detail))
  document.addEventListener('DropdownMenu:toggle', (e) => console.log('🟣 DOM Event - TOGGLE:', e.detail))
  document.addEventListener('DropdownMenu:collided', (e) => console.log('🟠 DOM Event - COLLIDED:', e.detail))
}
