...
<template>
  <BasePopup :modelValue="modelValue" @update:modelValue="(val) => emit('update:modelValue', val)"
    :popup-config="cartcheckoutLoginConfig">
    <div
      ...
      <div
        ...
        <CheckoutMediaPreview @update:modelValue="emit('update:modelValue', false)"
          image="https://i.ibb.co.com/SwFy98RJ/checkout-header.webp" creatorName="Princess Carrot Pop"
          creatorHandle="@sammisjelly187" :isVerified="true" volumeImg="" />
        ...
        <div
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
              <!-- title-container -->
              <SectionHeader title="ACCOUNT EMAIL" icon="https://i.ibb.co.com/LX2mCL2d/Communication.webp"
                :showClose="true" @close="emit('update:modelValue', false)" />
              ...
              <div class="flex justify-between items-end">
                ...
                <div class="flex items-center gap-2 py-1">
                  ...
                  <div class="flex flex-col">
                    ...
                    <span class="text-xs leading-normal font-medium text-[#98A2B3]">existingmember@gmail.com</span>
                  </div>
                </div>
                ...
                <button class="flex items-center gap-0.5 bg-transparent border-none outline-none cursor-pointer">
                  ...
                  <span class="text-xs leading-normal font-medium text-[#98A2B3]">Log out</span>
                </button>
              </div>
            </div>
            ...
            <div class="flex flex-col gap-6 md:hidden">
              <SectionToggleHeader title="ORDER SUMMARY" icon="https://i.ibb.co.com/xSK3W1w6/General.webp"
            ...
            <div class="flex flex-col gap-6">
              ...
              <div class="flex flex-col gap-4">
                <!-- title-container -->
                <div class="flex justify-between items-center border-b border-transparent">
                  <!-- section-title -->
                  <div class="flex items-center gap-2">
                    <div class="flex justify-center items-center w-5 h-5">
                      <img src="https://i.ibb.co.com/5gv74YLd/Maps-travel.webp" alt="location-marker" class="w-5 h-5" />
                    </div>
                  ...
                  <div class="flex items-center gap-2.5">
                    <span class="text-sm font-medium text-[#EAECF0]">Change Address</span>

                    <div class="flex justify-center items-center w-6 h-6 cursor-pointer">
                      <img src="https://i.ibb.co.com/qLW7tf3T/Arrows.webp" alt="chevron-down" />
                    </div>
                  </div>
                </div>

                <!-- form-container -->
                <AddressCard address="Chan Tai Man,10/F Block5,Fook Yip Bldg,12345,Kwai Chung,Hong Kong" />
              </div>
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex justify-between items-center border-b border-transparent">
                  ...
                  <div class="flex items-center gap-2">
                    <div class="flex justify-center items-center w-5 h-5">
                      <img src="https://i.ibb.co.com/m5nstLw2/svgviewer-png-output-30.png" alt="credit-card"
                  ...
                  <!-- arrow-container -->
                  <div class="flex items-center gap-2.5">
                    <span class="text-sm font-medium text-[#EAECF0]"></span>
      ...
      <div
        ...
        <div class="flex flex-col gap-4 w-full px-4">
          ...
          <CheckboxGroup
            ...
            I agree to Our Website's
            <a href=""
              class="text-sm leading-normal font-medium tracking-[0.0175rem] text-[#07F468] cursor-pointer">Terms and
              Condition</a>
            and
            <a href=""
              class="text-sm leading-normal font-medium tracking-[0.0175rem] text-[#07F468] cursor-pointer">Privacy
