<template>
  ...
  <div class="dashboard-two-col-container min-h-screen flex">
    ...
    <!-- Body / Main Content -->
    <div class="flex-1 p-1 sm:p-4 bg-[#F9FAFBE5] min-h-screen md:bg-transparent md:h-auto dark:bg-background-dark-app before:content-[''] 
...
<script setup>
import HeaderResponsive  from "@/templates/dashboard/HeaderResponsive.vue";
