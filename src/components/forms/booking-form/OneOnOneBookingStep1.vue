  ...
  import BookingSectionsWrapper from "@/components/forms/booking-form/parts/BookingSectionsWrapper.vue";
  import BaseInput from "@/components/forms/inputs/BaseInput.vue";
  import ThumbnailUploader from "@/components/media/uploader/parts/ThumbnailUploader.vue";
  ...
  const goToNext = async () => {
    ...
    if (!stepValidation.valid) {
      ...
      console.warn('[OneOnOneBookingStep1] step validation failed:', stepValidation.errors);
      return;
    }
