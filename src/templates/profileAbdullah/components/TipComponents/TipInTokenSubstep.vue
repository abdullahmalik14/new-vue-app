        ...
        <div class="flex flex-col gap-6">
            ...
            <div
                ...
                <div class="flex items-center gap-2">
                    ...
                    <BaseInput type="number" v-model="localTokenAmount" wrapperClass="" :show-controls="false"
                        inputClass="token-input w-full border-none bg-transparent
                             outline-none text-text-primary dark:text-text-dark-primary 
                             text-[2.5rem] font-semibold leading-[3.75rem]" />
                </div>
                <span
