...
import TipSpinner from '@/templates/profile/views/tip-components/TipSpinner.vue';
import TipSuccessAlert from '@/templates/profile/views/tip-components/TipSuccessAlert.vue';
import TipInTokenSubstep from '@/templates/profile/views/tip-components/TipInTokenSubstep.vue';
import TipInCashSubStep from '@/templates/profile/views/tip-components/TipInCashSubStep.vue';
