<template>
  <div class="social-linking-container w-full max-w-2xl mx-auto p-6">
    <div class="flex flex-col gap-6">
      <BaseHeading text="Social Account Linking" tag="h1" theme="AuthHeading" />

      <BaseParagraph text="Link your social media accounts to enable one-click login in the future." font-size="text-base"
...
import { getUserAttributes, unlinkSocialAccount } from "@/dev/utils/auth/awsCognitoHandler.js";
import { linkTwitterAccount } from "@/dev/utils/auth/twitterCognitoHandler.js";
import { linkTelegramAccount } from "@/dev/utils/auth/telegramCognitoHandler.js";
