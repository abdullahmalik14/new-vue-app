<template>
  <div
    ...
    <div v-show="isMoreVisible" class="fixed z-[100]" :style="flyoutWrapperStyle">
      <div class="hover-bridge absolute" :style="bridgeStyle" @mouseenter="handleMoreEnter" @mouseleave="handleMoreLeave"></div>
      <div class="sidebar-flyout bg-white rounded-2xl shadow-custom p-4 flex flex-col min-w-[200px]" 
           ref="flyoutInner"
           @mouseenter="handleMoreEnter" @mouseleave="handleMoreLeave">
