...
import ProfileSubscriptionPopup from '@/dev/components/ui/popups/profile/ProfileSubscriptionPopup.vue';

defineProps({
  price: { type: String, default: '$32' },
  oldPrice: { type: [String, Number], default: '45' },
});

const { t } = useI18n();
const { url: subscriberBtnImgUrl } = useAssetUrl('profile.subscribe.btnImg');
const { url: subscriberBtnHoverImgUrl } = useAssetUrl('profile.subscribe.btnHoverImg');
const { url: hotOfferUrl } = useAssetUrl('profile.subscribe.hotOffer');
const { url: buttonShapeUrl } = useAssetUrl('profile.subscribe.buttonShape');
                ...
                >
                  ...
                  >
                    <span class="w-[6.875rem] h-[6.25rem] block relative">
                      <img
                        :src="subscriberBtnImgUrl"
                        :alt="t('profile.alt.subscriberBtn')"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        :src="buttonShapeUrl"
                        :alt="t('profile.alt.subscriberShape')"
                    ...
                    >
                      <span
                        ...
                        >{{ t('profile.labels.subscribe') }}</span
                      >
                    </button>
                  </div>
                </div>
