...
<template>
            ...
            <div class="flex flex-col gap-2">
                <div
                    ...
                    <div class="flex items-baseline gap-2">
                        ...
                        <input type="number" v-model="localCashAmount"
    ...
    <div class="token-bottom-container px-2 flex flex-col gap-4 md:px-4 lg:px-6"
        ...
        <div class="flex items-center gap-2">
            <CheckboxGroup
                v-model="localIsAnonymous"
                label="Tip Anonymously"
                checkbox-class="peer h-0 w-0 opacity-0"
                label-class="hidden"
                wrapper-class="relative inline-block h-5 w-9 cursor-pointer !mb-0"
            >
