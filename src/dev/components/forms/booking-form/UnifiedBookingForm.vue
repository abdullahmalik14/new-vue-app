            ...
            <div
                ...
                <div class="w-full">
                    ...
                    <template v-if="currentType === 'private'">
                        <OneOnOneBookingStep1 v-if="currentStep === 1" :engine="bookingFlow" />

                        <OneOnOneBookingStep2 v-if="currentStep === 2" :engine="bookingFlow" />
                    </template>
...
// Import Steps
import OneOnOneBookingStep1 from "./OneOnOneBookingStep1.vue";
import OneOnOneBookingStep2 from "./OneOnOneBookingStep2.vue";
