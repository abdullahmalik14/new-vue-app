...
import TipStep1 from '@/dev/components/profile/tip-steps/TipStep1.vue';
import TipStep2 from '@/dev/components/profile/tip-steps/TipStep2.vue';
import TipStep3 from '@/dev/components/profile/tip-steps/TipStep3.vue';
