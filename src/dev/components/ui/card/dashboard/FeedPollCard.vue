        ...
        >
          ...
          <div class="flex justify-between items-center gap-2">
            ...
            <span
              ...
              >{{ option.percent }}% ({{ option.votes }} {{ t('profile.labels.voteSingular') }})</span
            >
          </div>
      ...
      <div class="flex items-center gap-[0.3125rem] shrink-0 h-6">
        <div class="flex items-center gap-1 min-w-[5.5rem]">
          ...
          <span
            ...
            >{{ totalVotes }} {{ t('profile.labels.votesSuffix') }}</span
          >
        </div>
        <span
...
const { t } = useI18n();
const { url: checkCircleUrl } = useAssetUrl("profile.card.checkCircle");
const { url: dashboardUrl } = useAssetUrl("profile.card.dashboard");
</script>
